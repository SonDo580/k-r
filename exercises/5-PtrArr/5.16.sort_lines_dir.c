...
int main(int argc, char *argv[])
{
    ...
    int fold = 0;    // 1 if ignore lower/upper case when comparing
    int dir = 0;     // 1 if only compare on letters, numbers, blanks
    ...
    void *, void *)
{
    ...
    if (fold)
        if (dir)
            return (int (*)(void *, void *))fold_dir_strcmp;
        else
            return (int (*)(void *, void *))fold_strcmp;
    else if (dir)
        return (int (*)(void *, void *))dir_strcmp;
    else
...
/* compare s1 and s2 lexicographically; only compare on letters, numbers, blanks.
 */
int dir_strcmp(char *s1, char *s2)
{
    int i, j;
    i = j = 0;
    while (s1[i] != '\0' && s2[j] != '\0')
...
- ignore case when comparing character
- only compare on letters, numbers, blanks.
*/
int fold_dir_strcmp(char *s1, char *s2)
{
    int i, j;
    i = j = 0;
    while (s1[i] != '\0' && s2[j] != '\0')
